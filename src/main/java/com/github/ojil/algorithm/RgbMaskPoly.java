...
/**
 * Masks a polygon in an RgbImage, setting the area inside or outside the
...
public class RgbMaskPoly extends PipelineStage {
     ...
     *            area outside.
     */
    public RgbMaskPoly(final Point points[], final boolean bInside) {
        this.points = points;
     ...
     */
    public RgbMaskPoly(final Quad quad, final boolean bInside) throws ImageError {
        points = new Point[4];
     ...
     */
    public RgbMaskPoly(final Rect rect, final boolean bInside) {
        points = new Point[4];
