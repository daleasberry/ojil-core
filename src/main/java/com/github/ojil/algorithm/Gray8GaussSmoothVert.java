...
public class Gray8GaussSmoothVert extends PipelineStage {
     ...
     * @throws com.github.ojil.core.Error is sigma is out of range.
     */
    public Gray8GaussSmoothVert(int cSigma) throws com.github.ojil.core.Error {
     ...
     * @throws com.github.ojil.core.Error if cSigma is out of range --
     * less than or equal to 1 or greater than the number of coefficients
     * we're precomputed.
     */
    public void setSigma(int cSigma) throws com.github.ojil.core.Error {
