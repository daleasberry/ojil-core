...
public class Fft1d {
     ...
     * @throws com.github.ojil.core.Error if width parameter is not a power of two.
     */
    public Fft1d(int nMaxWidth) throws com.github.ojil.core.Error {
     ...
     * @throws com.github.ojil.core.Error if image size is not a power of two or is larger than maximum width set in 
     * the constructor.
     */
    public Complex[] fft(Complex[] x) throws com.github.ojil.core.Error {
        int N = x.length;
        if ((N & (N-1)) != 0) {
            throw new Error(
    ...
    private Complex[] fft(Complex[] x, int nLog) throws com.github.ojil.core.Error {
        int N = x.length;
